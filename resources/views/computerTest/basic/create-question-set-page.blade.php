                    ...
                    <div class="row ">
                        <div class="col-md-11">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ url('/computer-test/basic/store-question-set') }}" method="POST">
                                        @csrf

                                        <div class="form-group">
                                            <label for="question_set_name">Question Set Name:</label>
                                            <input type="text" id="question_set_name" name="question_set_name" class="form-control" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="num_of_mcq">Number of MCQs (Part-A):</label>
                                            <input type="number" id="num_of_mcq" name="num_of_mcq" class="form-control" min="1" required>
                                            <span id="mcq-error" class="text-danger"></span>
                                        </div>

                                        <div class="form-group">
                                            <label for="num_of_true_false">Number of True/False Questions (Part-B):</label>
                                            <input type="number" id="num_of_true_false" name="num_of_true_false" class="form-control" min="1" required>
                                            <span id="true-false-error" class="text-danger"></span>
                                        </div>

                                        <div class="form-group">
                                            <label for="num_of_typing_test">Number of Typing Test Questions (Part-C):</label>
                                            <input type="number" id="num_of_typing_test" name="num_of_typing_test" class="form-control" min="1" required>
                                            <span id="typing-test-error" class="text-danger"></span>
                                        </div>

                                        <button type="submit" class="btn btn-primary">Generate Question Set</button>
                                    </form>
                                </div>
                            </div>
                        </div>
