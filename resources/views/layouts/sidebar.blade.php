...
{{--        <!-- Sidebar Menu -->--}}
{{--        <nav class="mt-2 " style="width: max-content">--}}
...
{{--                                       @if(request()->segment(1) == '/computer-test/basic/create-mcq-question') class="nav-link text-success"--}}
{{--                                       @else class="nav-link" @endif>--}}
{{--                                        <i class="far fa-circle nav-icon"></i>--}}
...
{{--                                       style="width: 250px"--}}
{{--                                       @if(request()->segment(1) == '/computer-test/basic/create-true-false-question') class="nav-link text-success"--}}
{{--                                       @else class="nav-link" @endif>--}}
{{--                                        <i class="far fa-circle nav-icon"></i>--}}
...
{{--                                </li>--}}
{{--                                <li class="nav-item">--}}
{{--                                    <a href="{{ asset('/create-typing-test-question') }}" style="width: 260px"--}}
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ asset('/computer-test/basic/create-mcq-question') }}"
                                       @if(request()->segment(1) == 'create-mcq-question') class="nav-link text-success"
                                       @else class="nav-link" @endif>
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create MCQ Question</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ asset('/computer-test/basic/create-true-false-question') }}"
                                       @if(request()->segment(1) == 'create-true-false-question') class="nav-link text-success"
                                       @else class="nav-link" @endif>
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create True/False Question</p>
                                    </a>
