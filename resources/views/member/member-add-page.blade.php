                                ...
                                <div class="card-body">
                                    <form action="{{ url('/store-member') }}" method="post">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"
                                                       ...
                                                       id="bpid" name="bpid" value="{{ old('bpid') }}" required>
                                                @error('bpid')
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <label for="designation_bn" class="form-label">Designation
                                                    (Bangla)</label>
                                                <input type="text"
                                                       class="form-control @error('designation_bn') is-invalid @enderror"
                                                       id="designation_bn" name="designation_bn"
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-control @error('post') is-invalid @enderror"
                                                        id="post" name="post" required>
                                                    <option value="">Select Post</option>
                                                    <option value="ADD-DIG" {{ old('post') == 'ADD-DIG' ? 'selected' : '' }}>
                                                        Additional-DIG
                                                    </option>
                                                    ...
                                                    <option value="ASP" {{ old('post') == 'ASP' ? 'selected' : '' }}>
                                                        Assistant Superintendent of Police (ASP)
                                                    </option>

                                                    <option
                                                        value="INSPECTOR" {{ old('post') == 'INSPECTOR' ? 'selected' : '' }}>
                                                        Inspector of Police (Insp.)

                                                    </option>
                                                    <option value="SI" {{ old('post') == 'SI' ? 'selected' : '' }}>Sub-Inspector (SI)

                                                    </option>
                                                    <option
                                                        value="SERGEANT" {{ old('post') == 'SERGEANT' ? 'selected' : '' }}>
                                                        SERGEANT
                                                    </option>

                                                    <option value="ASI" {{ old('post') == 'ASI' ? 'selected' : '' }}>
                                                        ASI
                                                    </option>
                                                    <option value="ATSI" {{ old('post') == 'ATSI' ? 'selected' : '' }}>
                                                        ATSI
                                                    </option>
                                                    <option
                                                        value="NAIK" {{ old('post') == 'NAIK' ? 'selected' : '' }}>
                                                        Naik
                                                    </option>

                                                    <option
                                                        value="CONSTABLE" {{ old('post') == 'CONSTABLE' ? 'selected' : '' }}>
                                                        CONSTABLE
                                                    </option>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"
                                                       ...
                                                       id="posting_area" name="posting_area"
