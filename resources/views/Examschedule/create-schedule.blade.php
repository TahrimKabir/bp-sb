                                    ...
                                    <form action="{{ route('store-schedule') }}" id="sform" method="post"
                                                        ...
                                                        @if ($exam != null)
                                                            @foreach ($exam as $e)
                                                                <option value="{{ $e->exam_id }}"
                                                                        data-type="{{ $e->type }}">{{ $e->exam_name }}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </label>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                ...
                                                <p class="mb-0 text-danger" id="errordate" style="display: none;">The
                                                    date has passed already!</p>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6 mt-md-0 mt-2">
                                                ...
                                                <p class="mb-0 text-danger" id="show" style="display: none;"
                                                   >
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-12 d-flex">
                                                <button type="submit" id="submitbutton"
                                                        class="btn btn-sm clr-dark-green ml-auto">
                                                    create
                                                </button>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        function checkExamType() {
            ...
            if (examType === 'basic_computer_test') {
                addBasicComputerTestInputFields();
            }
        }


        function addBasicComputerTestInputFields() {
