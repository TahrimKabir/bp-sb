                            ...
                            <div class="card">
                                <div class="card-header clr-dark-green text-white">
                                    <h2 class="display-6 mb-0 text-center">
                                        Add Members for Exam Configuration: {{ $examConfiguration->name }}
                                    </h2>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form action="{{url('/store-member-to-schedule')}}" id="sform" method="post"
                                          onsubmit="submitForm()">
                                        @csrf

                                        <input type="hidden" name="exam_config_id" value="{{ $examConfiguration->id }}">
                                        <div class="row mt-2">
                                            <div class="col-12">
