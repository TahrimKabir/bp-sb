    ...
    <div class="container">
        ...
        <div class="row text-center">
            ...
            <div class="col-12 d-flex justify-content-center">
                <img src="../img/course3/c3c6.png" alt="" class="d-none d-md-block mx-auto w-100 w-lg-75 w-xl-60">
                <img src="../img/course3/c3c6_mobile.png" alt="" class="w-100 mx-auto d-md-none">
            </div>
        </div>
        <hr>
        <div>
        ...
        <div class="d-flex justify-content-between mt-5">
            <a href="lesson.php?lesson_id=17" class="btn btn-outline-primary rounded-pill"><i class="fas fa-arrow-left"></i> পূর্ববর্তী </a>
            <a href="lesson.php?lesson_id=19" class="btn btn-outline-primary rounded-pill"> পরবর্তী <i class="fas fa-arrow-right"></i></a>
        </div>
    </div>
</div>
<!-- Course 1 Chapter 1 -->