...
<div class="container-xxl py-4 mb-5">
    <div class="container">
        <div class="d-flex justify-content-between">
            <h5>কুইজ (জেন্ডারভিত্তিক সহিংসতা বিষয়ক প্রশিক্ষণ)</h5>
        ...
        <div>
            <form action="" method="">
                ...
                <div class="text-end">
                    <a href="course2result.php" type="submit" class="btn btn-primary rounded-pill">Submit <i class="fas fa-arrow-right"></i></a>
                </div>
            </form>
        </div>
    </div>
