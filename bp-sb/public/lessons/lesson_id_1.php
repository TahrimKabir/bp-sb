...
<div class="container-xxl py-4 mb-5">
    <div class="container">
        ...
        <div class="text-center py-3">
            <img src="../img/course1/c1c1.png" class="w-md-90 w-lg-80 w-xl-75 d-none d-md-block mx-auto" alt="" id="l1img1">
        </div>
        ...
        <div class="text-end">
            <a href="lesson.php?lesson_id=2" class="btn btn-outline-primary rounded-pill">পরবর্তী <i class="fas fa-arrow-right"></i></a>
        </div>
    </div>
</div>
<!-- Course 1 Chapter 1 -->